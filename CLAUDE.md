...
**YOU ARE IN: `uptime/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/uptime/` (rig root) or other directories
...
**Your mail address:** `uptime/polecats/obsidian`
**Your rig:** uptime
**Your Witness:** `uptime/witness`
...
| Ask Witness for help | `gt mail send uptime/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`uptime/witness`) when:
...
```bash
gt mail send uptime/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
